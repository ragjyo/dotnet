...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 110875885007.dkr.ecr.ap-south-1.amazonaws.com/project
	 docker build -t 110875885007.dkr.ecr.ap-south-1.amazonaws.com/project:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 110875885007.dkr.ecr.ap-south-1.amazonaws.com/project:SAMPLE-PROJECT-${BUILD_NUMBER}
